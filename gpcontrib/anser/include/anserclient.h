 ...
 *
 * IDENTIFICATION
 *	  gpcontrib/anser/include/anserclient.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef ANSERCLIENT_H
#define ANSERCLIENT_H

#include "anser.h"

/*
 * Publish one producer part to the coordinator.  Opens a short-lived libpq
 * connection to the QD, runs anser.producer_begin + anser.publish, and
 ...
 * parallel-retrieve-cursor model: anser.conn=true + token as password,
 ...
 * query-lifetime libpq connection to the QD, runs anser.consume_wait, and
